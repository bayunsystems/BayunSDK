...
- (void)updatePosition {
    ...
    [self.imageView setFrame:CGRectMake(0, 0, 28, 28)];
    ...
    if(string) {
        ...
        CGSize maximumSize = CGSizeMake(200, 300);
        
        CGRect textRect = [string boundingRectWithSize:maximumSize
        ...
        stringWidth = textRect.size.width;
        stringHeight = textRect.size.height;
        if (imageUsed)
...
- (UIFont *)hudFont {
    //return [UIFont fontWithName: size:18];
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 50000
    if(_uiHudFont == nil) {
