...
- (void)scrollToBottomAnimated:(BOOL)animated
{
    ...
    CGSize contentViewSize = [self.collectionView.collectionViewLayout collectionViewContentSize];
...
*/
    ...
    cell.timeStampLabel.attributedText = [RCUtilities getTimestamp:[messageItem date] fontSize:10.0f];


    cell.backgroundColor = [UIColor clearColor];
    
    CGFloat bubbleTopLabelInset = (avatarImageDataSource != nil) ? 42.0f : 42.0f;
