...
7. Enter the values of the constants kApplicationKeySandbox, kApplicationSecretKeySandbox, kApplicationKeyProd, kApplicationSecretKeyProd, kBaseURL, kBayunAppId, kBayunAppSecret and kBayunAppSalt in RCConfig.h file.
