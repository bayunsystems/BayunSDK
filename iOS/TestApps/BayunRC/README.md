...
4. Embed the Bayun framework in project
       ...
       iii. On the popup, click "Add Other..." 
        iv. Select Bayun.framework from BayunSDK/iOS/BayunCoreSDK and click "Open". A pop up opens to choose options for adding the files. Choose  the  options “Copy times if needed” and “Create groups”. Click on Finish. This integrates the Bayun framework into the app.
