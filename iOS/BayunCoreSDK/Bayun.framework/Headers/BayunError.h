...
typedef NS_ENUM(NSUInteger, BayunError) {
  ...
  BayunErrorRegistrationFailedAppNotApproved,
    /**If vishwam face authenication failed, library returns BayunErrorVishwamFaceVerificationFailed **/
    BayunErrorVishwamFaceVerificationFailed,
    /**If vishwam authtoken failed, library returns BayunErrorVishwamAuthtokenFailed **/
    BayunErrorVishwamAuthtokenFailed
};
