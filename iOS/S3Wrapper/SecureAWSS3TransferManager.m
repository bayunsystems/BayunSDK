...
- (AWSTask *)upload:(AWSS3TransferManagerUploadRequest *)uploadRequest
    ...
    if ([uploadRequest.bucket length] == 0) {
        ...
        return [AWSTask taskWithError:[NSError errorWithDomain:SecureAWSS3TransferManagerErrorDomain
                                                          code:SecureAWSS3TransferManagerErrorMissingRequiredParameters
                                                      userInfo:userInfo]];
    }
    ...
    if (uploadRequest.body == nil) {
        ...
        return [AWSTask taskWithError:[NSError errorWithDomain:SecureAWSS3TransferManagerErrorDomain
                                                          code:SecureAWSS3TransferManagerErrorInvalidParameters
                                                      userInfo:userInfo]];
    }
    ...
    if (uploadRequest.state == AWSS3TransferManagerRequestStateCompleted) {
        ...
        return [AWSTask taskWithError:[NSError errorWithDomain:SecureAWSS3TransferManagerErrorDomain
                                                          code:SecureAWSS3TransferManagerErrorCompleted
                                                      userInfo:userInfo]];
...
- (void)download:(AWSS3TransferManagerDownloadRequest *)downloadRequest continueWithExecutor:(AWSExecutor *)executor
       withBlock:(AWSContinuationBlock)block {
    ...
    if ([task.error.domain isEqualToString:@"com.amazonaws.AWSS3TransferManagerErrorDomain"]) {
        ...
        switch (task.error.code) {
            ...
            case AWSS3TransferManagerErrorInternalInConsistency:
                return [AWSTask taskWithError:[NSError errorWithDomain:SecureAWSS3TransferManagerErrorDomain
                                                                  code:SecureAWSS3TransferManagerErrorInternalInConsistency
                                                              userInfo:error.userInfo]];
            case -1009:
                return [AWSTask taskWithError:[NSError errorWithDomain:SecureAWSS3TransferManagerErrorDomain
                                                                  code:SecureAWSS3TransferManagerErrorNoInternetConnection
                                                              userInfo:error.userInfo]];
            default:
                return task;
        }
