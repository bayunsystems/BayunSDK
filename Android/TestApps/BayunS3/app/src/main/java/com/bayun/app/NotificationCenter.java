...
public class NotificationCenter {
    ...
    //aws
    public static final int AWS_UPLOAD_COMPLETE = 71;
    public static final int AWS_DOWNLOAD_COMPLETE = 72;
    public static final int AWS_DOWNLOAD_LIST = 73;
    public static final int AUTH_KEY_AVAILABLE = 50;
    public static final int AUTH_KEY_NOT_AVAILABLE = 51;
    public static final int S3_BUCKET_ADD_NEW_FILE = 52;
    public static final int S3_BUCKET_FILE_EXIST = 53;
    public static final int S3_BUCKET_FILE_NOT_EXIST = 54;
    ...
    public static final int S3_BUCKET_ERROR = 59;
    ...
    static final private HashMap<Integer, Object> addAfterBroadcast = new HashMap<Integer, Object>();
