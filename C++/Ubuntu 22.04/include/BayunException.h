...
#define BAYUN_ERR_GROUP_KEYS_NOT_FOUND       (BAYUN_SYSERR_MAX+78)
#define BAYUN_ERR_EMP_APP_NOT_APPROVED       (BAYUN_SYSERR_MAX+79)
#define BAYUN_REGISTRATION_FAILED_APP_NOT_APPROVED       (BAYUN_SYSERR_MAX+80)
...
#define BAYUN_ERR_MAX               (BAYUN_SYSERR_MAX+81)
